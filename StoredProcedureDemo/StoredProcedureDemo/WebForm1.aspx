<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WebForm1.aspx.cs" Inherits="StoredProcedureDemo.WebForm1" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <br />
        <asp:EntityDataSource ID="EntityDataSource1" runat="server" ConnectionString="name=SpEmployeeDBContext" DefaultContainerName="SpEmployeeDBContext" EnableDelete="True" EnableFlattening="False" EnableInsert="True" EnableUpdate="True" EntitySetName="SpEmployees">
